...
@Component({
  ...
  template: `
    <app-legal-layout
      ...
      <p>
        La pr&eacute;sente politique d&eacute;crit la mani&egrave;re dont Joseph&nbsp;&middot;&nbsp;Yusuf
        (ci-apr&egrave;s &laquo;&nbsp;nous&nbsp;&raquo;) collecte, utilise et prot&egrave;ge les
        donn&eacute;es personnelles de ses utilisateurs, conform&eacute;ment au
        R&egrave;glement G&eacute;n&eacute;ral sur la Protection des Donn&eacute;es (RGPD - UE 2016/679)
        et &agrave; la loi fran&ccedil;aise &laquo;&nbsp;Informatique et Libert&eacute;s&nbsp;&raquo;.
      </p>

      <h2>1. Responsable du traitement</h2>
      <p>
        <strong>Rey Dedy Pangou</strong>, &eacute;diteur du Service, est le responsable du traitement
        des donn&eacute;es personnelles collect&eacute;es via la plateforme.<br>
        Contact :
      ...
      <ul>
        ...
        <li><strong>Paiement</strong> : identifiants de transaction Stripe/Wave/Orange Money (jamais les num&eacute;ros de carte ou les donn&eacute;es bancaires compl&egrave;tes)</li>
      </ul>
      ...
      <ul>
        ...
        <li>Traiter les paiements et g&eacute;rer les abonnements via nos prestataires certifi&eacute;s</li>
      ...
      <ul>
        <li><strong>Stripe</strong> (paiement) &mdash; Irlande, certifi&eacute; PCI-DSS niveau 1</li>
        <li><strong>Wave Mobile Money</strong> (paiement Afrique de l'Ouest) &mdash; S&eacute;n&eacute;gal</li>
        <li><strong>Orange Money</strong> (paiement Afrique de l'Ouest) &mdash; France/Afrique</li>
        <li><strong>Hetzner</strong> (h&eacute;bergement serveurs) &mdash; Allemagne, ISO 27001</li>
        <li><strong>SendGrid / Mailgun</strong> (envoi d'emails transactionnels) &mdash; UE</li>
      </ul>
      <p>
        Aucune donn&eacute;e n'est revendue &agrave; des tiers commerciaux. Aucun transfert hors UE
        n'est effectu&eacute; sans garanties appropri&eacute;es (clauses contractuelles types).
      </p>
      ...
      <p>Vous disposez des droits suivants sur vos donn&eacute;es personnelles :</p>
      <ul>
        ...
        <li><strong>Droit &agrave; la limitation</strong> : restreindre un traitement</li>
      </ul>
      <p>
      ...
      <p>
        ...
        Les donn&eacute;es bancaires compl&egrave;tes ne sont jamais stock&eacute;es sur nos
        serveurs &mdash; elles sont trait&eacute;es exclusivement par Stripe (PCI-DSS).
      </p>
      ...
      <p>
        ...
        n'est d&eacute;pos&eacute;. Votre consentement n'est donc pas requis pour ces cookies
        techniques.
      </p>
