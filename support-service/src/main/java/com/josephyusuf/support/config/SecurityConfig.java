package com.josephyusuf.support.config;

import com.josephyusuf.support.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/actuator/**", "/ws/**", "/api/support/knowledge/public/**").permitAll()
