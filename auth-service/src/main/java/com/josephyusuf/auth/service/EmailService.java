...
public class EmailService {
    ...
    public void sendTrialWelcome(User user) {
        ...
        String body = GREETING + user.getFirstName() + ",\n\n"
                ...
                + "Tu as 7 jours d'accès PREMIUM+ pour découvrir l'outil "
                + "tranquillement. Accès gratuit valable jusqu'au "
                + expirationDate + ".\n\n"
                + "----------------------------------------\n"
                + "Tes premiers pas (5 minutes)\n"
                + "----------------------------------------\n\n"
                + "L'outil prend tout son sens dès que tes vrais revenus sont "
                + "dedans. Voici par où commencer :\n\n"
                + "1. Ajoute ta ou tes source(s) de revenu\n"
                + "   Section « Mes Revenus » (lien dans la barre du haut sur\n"
                + "   ordinateur, ou icône menu ☰ en haut à gauche sur mobile)\n"
                + "   → onglet « Mes sources de revenus ».\n"
                + "   Salaire, freelance, loyer, Mobile Money — tout ce qui rentre.\n\n"
                + "2. Renseigne ce que tu as gagné ce mois-ci\n"
                ...
                + "   la classification soit pertinente — pense à importer ton\n"
                + "   historique si tu en as un.\n\n"
                + "Besoin de plus de détails ? Le bouton « Comment ça marche » "
                + "(web) ou l'icône « ? » (mobile) est dispo sur toutes les pages.\n\n"
                + "----------------------------------------\n"
                + "Ce que tu débloques pendant les 7 jours\n"
                + "----------------------------------------\n\n"
